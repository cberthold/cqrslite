...
{
    public class ConventionEventRouter<TAggregate> : IRouteEvents<TAggregate>
        where TAggregate : AggregateBase<TAggregate>
    {
        ...
        private IAggregate<TAggregate> registered;
        ...
        public ConventionEventRouter(bool throwOnApplyNotFound, IAggregate<TAggregate> aggregate)
        ...
        public virtual void Register(IAggregate<TAggregate> aggregate)
        {
            if (aggregate == null)
            {
